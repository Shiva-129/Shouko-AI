    ...
    <div className="min-h-screen flex items-center justify-center bg-canvas p-4">
      <Card className="w-full max-w-md bg-card border-border">
        <CardHeader className="text-center">
          <div className="font-syne font-extrabold text-2xl text-primaryText mb-2">
        ...
        <CardContent className="space-y-4">
          <Button
            variant="outline"
            className="w-full border-border text-primaryText hover:bg-surface"
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-secondaryText">or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailSignup} className="space-y-3">
            <Input
              ...
              className="bg-surface border-border text-primaryText"
              required
            />
            <Input
              type="password"
            ...
            <Button type="submit" className="w-full bg-lime text-black hover:bg-lime/90" disabled={loading}>
